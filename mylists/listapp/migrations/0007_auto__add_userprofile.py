...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('listapp_userprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('mailbox', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['mailfetcher.MailBox'], unique=True)),
        ))
        db.send_create_signal('listapp', ['UserProfile'])


    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table('listapp_userprofile')
